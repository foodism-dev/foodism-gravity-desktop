...
import { USER_PROFILE_IPC_CHANNELS, SETTINGS_IPC_CHANNELS, SCRATCH_PAD_IPC_CHANNELS, APP_ICON_IPC_CHANNELS, DOCK_BADGE_IPC_CHANNELS, STORAGE_IPC_CHANNELS, AUTH_IPC_CHANNELS, REBUILD_IPC_CHANNELS } from '../types'
import type {
  RuntimeStatus,
  GitRepoStatus,
  Channel,
...
export interface ElectronAPI {
  ...
  /** 查询 SupplyGoods 多条记录 */
  listSupplyGoods: (request?: RebuildEntityListRequest) => Promise<RebuildSupplyGoodsListResult>

  /** 查询 SupplyGoods 单条记录 */
  getSupplyGoods: (request: RebuildEntityGetRequest) => Promise<RebuildSupplyGoodsRecord>

  /** 获取 SupplyGoods approvalState 选项 */
  getSupplyGoodsApprovalStateOptions: () => Promise<RebuildFieldOption[]>
...
const electronAPI: ElectronAPI = {
  ...
  // REBUILD OpenAPI
  listSupplyGoods: (request?: RebuildEntityListRequest) => {
    return ipcRenderer.invoke(REBUILD_IPC_CHANNELS.LIST_SUPPLY_GOODS, request)
  },

  getSupplyGoods: (request: RebuildEntityGetRequest) => {
    return ipcRenderer.invoke(REBUILD_IPC_CHANNELS.GET_SUPPLY_GOODS, request)
  },

  getSupplyGoodsApprovalStateOptions: () => {
    return ipcRenderer.invoke(REBUILD_IPC_CHANNELS.GET_SUPPLY_GOODS_APPROVAL_STATE_OPTIONS)
  },
